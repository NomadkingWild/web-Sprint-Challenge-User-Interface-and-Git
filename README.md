...
semantic HTML is HTML that reinforces the meaning of the content on the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
inlines dont cause a new line in the document beginning. blocks force a break in the lines. you cant put a break in an inline.
3. What are the 4 areas of the box model?
Margin, border, Padding, Content.
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
The cross axis
5. Explain why git is valuable to a team of developers.
It allows a Team to work separately on a project and allows each member to have there own copy of the file/folder and to be able to see changes, and roll back if necessary.
...
- [ ] Clone your OWN version of the repository (Not Lambda's by mxistake!).
